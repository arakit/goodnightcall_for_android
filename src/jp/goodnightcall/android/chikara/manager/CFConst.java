...
public class CFConst {
	...
	public static final String DOMAIN = "180.0.51.75";
...
//	public static final String DEL_CONTRIBUTE = "HeallinServer0/DeleteContribute";
	...
	public static final String CREATE_ACCOUNT = ROOTDIR + "register";
	public static final String CALL_START = ROOTDIR + "start_call";
	public static final String CALL_STOP = ROOTDIR + "stop_call";
