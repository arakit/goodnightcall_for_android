package jp.goodnightcall.android.chikara.manager;
...
public class LoginManager {
	...
	private static String START_CALL_URL = CFConst.SERVER + CFConst.CALL_START;
	private static String STOP_CALL_URL = CFConst.SERVER + CFConst.CALL_STOP;
...
//	private static String DEL_CONTRIBUTE_URL = CFConst.SERVER + CFConst.DEL_CONTRIBUTE;
	...
	public LoginInfo login(String id, String password,String[] outResult){
		...
		if(true){
			...
			li.id = "user0";
			li.name = "ユーザー0";
			li.sid = new SessionID("aaa");
			li.password = "hogehoge";
			return li;
		}
...
//	}
	...
	//アカウントを作成します
	public boolean createUser(String id, String password,String phone_number, int user_sex, String[] outResult){

		ArrayList<NameValuePair> params = new ArrayList<NameValuePair>();

		params.add(new BasicNameValuePair("user_id", id));
		params.add(new BasicNameValuePair("user_password", password));
		params.add(new BasicNameValuePair("user_phone_number", phone_number));
		params.add(new BasicNameValuePair("user_sex", ""+user_sex));

		HttpResponseData rd = null;

		rd = CFUtil.postData(CREATE_ACCOUNT_URL, params, null);
...
//			String res_token = json.getString("");
	...
	//
	public boolean call_start(LoginInfo l){
		...
		params.add(new BasicNameValuePair("user_id", ""+l.id));
		...
		rd = CFUtil.postData(START_CALL_URL, params, cookie);
		...
		log(rd.data);
		 ...
		 return Boolean.getBoolean(rd.data);

//		try{
//			JSONObject jdata = new JSONObject(rd.data);
//
//
//			return "";
//		}catch(Exception e){
...
//		return info;
	...
	public boolean call_stop(LoginInfo l){
		...
		rd = CFUtil.postData(STOP_CALL_URL, params, cookie);
